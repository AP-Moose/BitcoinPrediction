...
custom_start_date = st.sidebar.date_input("Select Start Date", datetime.now() - timedelta(days=365))
...
predictions = make_prediction(model, combined_data, prediction_period)
